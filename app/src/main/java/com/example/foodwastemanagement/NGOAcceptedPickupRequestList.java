...
public class NGOAcceptedPickupRequestList extends AppCompatActivity
{
    ...
    private void showNotification(String title,String message){
        ...
        Intent intent = new Intent(this, NGOAcceptedPickupRequestList.class);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    {
                        //                 Toast.makeText(NGOAcceptedPickupRequestList.this,"Saved Successfully",Toast.LENGTH_SHORT).show();
                        getAndLoadData();
                    }
                    else {
                        Toast.makeText(NGOAcceptedPickupRequestList.this, "some error has occured", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NGOAcceptedPickupRequestList.this,error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
                ...
                try {
                    ...
                    if(!object.getBoolean("error"))
                    {
                        if(object.getString("list").equals("[[]]")){
                            Toast.makeText(NGOAcceptedPickupRequestList.this,"List is empty !",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            JSONArray jsonArray = object.getJSONArray("list");
                            list=new ArrayList<>();
                            //  Toast.makeText(NGOAcceptedPickupRequestList.this,object.getString("message"),Toast.LENGTH_SHORT).show();
                    ...
                    else Toast.makeText(NGOAcceptedPickupRequestList.this,"something went wrong",Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT || direction == ItemTouchHelper.RIGHT)
                {
                    ...
                    DialogWithButtons dialog = new DialogWithButtons(NGOAcceptedPickupRequestList.this, new DialogWithButtons.OnDialogButtonClickListener() {
                        @Override
                        public void onPositiveClicked(@NonNull DialogWithButtons d) {
                            saveChangesOnServer();
                            Toast.makeText(NGOAcceptedPickupRequestList.this,"Success",Toast.LENGTH_SHORT).show();
                            d.dismiss();
                        }
                        @Override
                        public void onNegativeClicked(@NonNull DialogWithButtons d) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(!object.getBoolean("error"))
                    {
                        Toast.makeText(NGOAcceptedPickupRequestList.this,"Successfully accepted the request",Toast.LENGTH_SHORT).show();
                        getAndLoadData();
                    }
                    else {
                        Toast.makeText(NGOAcceptedPickupRequestList.this, "some error has occured", Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(!object.getBoolean("error"))
                    {
                        ...
                        adapter = new MyAdapter(list, NGOAcceptedPickupRequestList.this, (view, item, position) -> {
                            ListItemModel listItemModel = (ListItemModel) item;
                            final Dialog dialog = new Dialog(NGOAcceptedPickupRequestList.this);
                            ...
                            callIv.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    AlertDialog alertDialog = new AlertDialog.Builder(NGOAcceptedPickupRequestList.this)
                                            .setCancelable(false)
